...
export declare const createBetterAuthClient: (baseURL: string) => {
    signIn: {
    ...
    useSession: () => import("better-auth/svelte").Atom<{
        data: {
            user: {
                id: string;
                email: string;
    ...
    $store: {
        ...
        atoms: Record<string, import("better-auth/svelte").WritableAtom<any>>;
    };
    $Infer: {
        Session: {
            user: {
...
export declare const createAuthConfig: (database: any, trustedOrigins: string[]) => any;
