...
export const createPasswordSchema = (minLength = 8) => z.string().min(minLength, `Password must be at least ${minLength} characters`);
export const createRequiredStringSchema = (fieldName) => z.string().min(1, `${fieldName} is required`);
